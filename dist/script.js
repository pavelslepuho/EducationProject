...
/* harmony import */ var _modules_sliders_mainSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliders/mainSlider */ "./src/js/modules/sliders/mainSlider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  new _modules_sliders_mainSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.page',
    btns: '.next'
  }).render();
  ...
  new _modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"](".join__evolution .form", "http://localhost:3000/posts_1").init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"](".schedule__form .form", "http://localhost:3000/posts_2").init();
});
...
/* harmony default export */ __webpack_exports__["default"] = (Differences);
    ...
    value: function showHanson() {
      ...
      if (this.n === 3 && this.t === 0) {
        this.timer = setTimeout(function () {
          _this2.hanson.style.transition = '0.6s linear';
    ...
    value: function render() {
      ...
      this.btns.forEach(function (item) {
        item.addEventListener('click', function () {
          ...
          if (_this3.n > _this3.slides.length) {
            _this3.n = 1;
          }

          _this3.showPages(_this3.n);
...
function (_Slider) {
  ...
  function MiniSlider(container, btns, next, prev, activeClass) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, btns, next, prev, activeClass));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.next.addEventListener('click', function () {
        _this2.container.children.forEach(function (slide) {
          // slide.classList.add('animated', "fadeOutLeft");
          _this2.margin = window.getComputedStyle(slide).getPropertyValue("margin-right");
          slide.style.cssText = "\n                    transition: .5s all;\n                    transform: translateX(calc(-100% - ".concat(_this2.margin, "));\n                ");
        });
        ...
        setTimeout(function () {
          ...
          _this2.container.append(_this2.container.children[0]);

          if (_this2.container.children[0].tagName === 'BUTTON') {
            for (var i = 0; i < _this2.container.children.length; i++) {
              if (_this2.container.children[0].tagName === 'BUTTON') {
                _this2.container.append(_this2.container.children[0]);

                i--;
              } else if (_this2.container.children[0].tagName === 'DIV') {
      ...
      this.prev.addEventListener('click', function () {
        ...
        setTimeout(function () {
          ...
          if (_this2.container.children[_this2.container.children.length - 1].tagName === 'BUTTON') {
            for (var i = 1; i <= _this2.container.children.length; i++) {
              if (_this2.container.children[_this2.container.children.length - i].tagName === "DIV") {
                _this2.container.prepend(_this2.container.children[_this2.container.children.length - i]);
            ...
            _this2.container.prepend(_this2.container.children[_this2.container.children.length - 1]);
