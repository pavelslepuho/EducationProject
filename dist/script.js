...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"]('.page', '.next').render();
  var player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup .play', '.overlay').init();
});
    ...
    value: function showHanson() {
      ...
      if (this.n === 3 && this.t === 0) {
        this.timer = setTimeout(function () {
          _this.hanson.style.transition = '0.6s linear';
    ...
    value: function render() {
      ...
      this.btns.forEach(function (item) {
        item.addEventListener('click', function () {
          ...
          if (_this2.n > _this2.slides.length) {
            _this2.n = 1;
          }

          _this2.showPages(_this2.n);
